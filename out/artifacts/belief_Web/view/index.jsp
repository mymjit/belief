...
<div class="container">
    ...
    <div class="small_screen" style="margin-top: 10px; margin-bottom: 10px;">
        <div class="dropdown">
            <button class="btn dropdown-toggle btn-primary btn-lg btn-block" id="dLabel" type="button"
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                <div class="well well-sm">
                                    ...
                                    <button type="button" style="margin-top: 5px; margin-left: 93%;"
                                            class="btn btn-info btn-sm">评论
                                    </button>
                                </div>
                                <div class="well well-sm">
                                    <p class="text-left">
                                        Left aligned text. Left aligned text.Left aligned text.Left aligned text.Left
                                        aligned text.Left aligned text.
                                    </p>
